...
if(isset($_POST['book'])){
    ...
    $success_url = 'https://localhost/TrainTicketWebApp/successPage.php?session_id={CHECKOUT_SESSION_ID}'; // Replace with your success URL
    $cancel_url = 'https://localhost/TrainTicketWebApp/cancelPage.php?session_id={CHECKOUT_SESSION_ID}'; // Replace with your cancel URL
